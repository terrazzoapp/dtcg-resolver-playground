...
export default function Nav({ preset, onPresetChange }: NavProps) {
  return (
    // biome-ignore lint/a11y/useAriaPropsSupportedByRole: this is wrong
    <header aria-label="Controls" className={s.container}>
      <menu className={s.menu} aria-label="Design System">
        <Select
          value={preset}
          label={<>Preset</>}
          onChange={(e) => {
      ...
      <nav className={s.nav}>
        ...
        <a
          className={s.link}
          href="https://github.com/terrazzoapp/dts-playground"
